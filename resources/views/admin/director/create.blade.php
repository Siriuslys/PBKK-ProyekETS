        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-700">Add Director</h1>
                ...
                <form action="{{ route('admin/directors/save') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    <div>
